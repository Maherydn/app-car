...
export const CarModal = ({ car, isOpen, onClose }) => {
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
      ...
      <button
        className="absolute top-5 right-4 bg-white text-red-500 hover:bg-red-500 hover:text-white px-1.5 py-0 rounded-lg text-sm font-bold duration-200 border border-red-500 transform -translate-x-1/2 -translate-y-1/2"
        onClick={onClose}
      >
        X
      </button>
